...
/**
 * Builder for the 500 Internal Server Error page.
 *
 * @param {object} ctx - Context object provided by the router.
 */
export default function error500Builder(ctx)
{
  // Define the message for a 500 error
  const statusMessage = "Internal Server Error";

  // Provide the container HTML for the error page
  ctx.container = () => setErrorHydration(500, statusMessage);
