...
/**
 * Adjust the <script src="./spa.js"></script> tag
...
function adjustSpaScript(htmlContent, reqUrl) {
  ...
  // Replace the script tag with the computed relative path
  return htmlContent.replace(
    /<script\s+src=["']\.\/spa\.js["']><\/script>/i,
    `<script src="${relativePrefix}spa.js"></script>`
  );
}
